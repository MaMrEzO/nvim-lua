...
local function copy(args)
	print("str is ", vim.inspect(args[1][0]))
	return args[1]
end

local function copyIndentifier(args)
	local str = args[1][0]
	print("str is ", vim.inspect(str))
...
ls.add_snippets("all", {
	...
	s("transform", {
		...
		l(l._1:match("\\w"):gsub("i", "o"):gsub(" ", "_"):upper(), 1),
	}),
...
ls.add_snippets("typescript", {
	s("inj", {
		t({ "import { Injectable } from '@nestjs/common';", "", "@Injectable()", "" }),
		t("export class "),
		i(1),
		t({ " {", "\t" }),
		t({ "constructor(", "\t\t" }),
