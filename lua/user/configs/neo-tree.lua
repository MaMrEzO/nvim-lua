return function()
	...
	--	callback = function(ev)
	--		print('Huh got it')
	--		--vim.api.nvim_set_option_value('modeline', false, { buf = ev })
	--		vim.api.nvim_buf_set_option('relativenumber', true, { buf = ev.buf })
	--	end
	--})
	--vim.cmd([[ autocmd BufWinEnter NvimTree setlocal relativenumber ]])
	--vim.cmd([[ autocmd BufWinEnter NvimTree set relativenumber ]])
